  ...
  router.all("/retry/:code", function (req, res, next) {
    ...
    if (scenario !== null) {
      if (isRetryRequest(req, code, req.method.toLowerCase())) {
        ...
        utils.sendError(
          code,
          addRetryTracker(res, code, req.method.toLowerCase()),
          next,
          "Retry scenario initial request",
        );
      }
    } else {
    ...
    if (scenario !== null) {
      ...
      if (req.params.type === "valid") {
        ...
        utils.send400(
          res,
          next,
          'Unable to parse multiple response scenario with return code "' +
            req.params.code +
            '" and type "' +
            req.params.type +
            '"',
      ...
      utils.send400(
        res,
        next,
        'Unable to parse multiple response scenario A (One success response with model, one success response with no model, default error model) with return code "' +
          req.params.code +
          '" and type "' +
          req.params.type +
          '"',
    ...
    if (scenario !== null) {
      ...
      if (req.params.type === "valid") {
        ...
        utils.send400(
          res,
          next,
          'Unable to parse multiple response scenario B with return code "' +
            req.params.code +
            '" and type "' +
            req.params.type +
            '"',
      ...
      utils.send400(
        res,
        next,
        'Unable to parse multiple response scenario B (Two success responses with common base model, default error response with model) with return code "' +
          req.params.code +
          '" and type "' +
          req.params.type +
          '"',
  ...
  router.get("/payloads/200/A/201/C/404/D/default/Error/response/:code/:type", function (req, res, next) {
    ...
    if (scenario !== null) {
      ...
      utils.send400(
        res,
        next,
        'Unable to parse multiple response scenario C (Three success responses with models with no common base type, default error response with model) with return code "' +
          req.params.code +
          '" and type "' +
          req.params.type +
          '"',
  ...
  router.get("/payloads/202/none/204/none/default/Error/response/:code/:type", function (req, res, next) {
    ...
    if (scenario !== null) {
      ...
      utils.send400(
        res,
        next,
        'Unable to parse multiple response scenario D (Two success responses with no model and one default response with no model) with return code "' +
          req.params.code +
          '" and type "' +
          req.params.type +
          '"',
  ...
  router.get("/payloads/202/none/204/none/default/none/response/:code/:type", function (req, res, next) {
    ...
    if (scenario !== null) {
      ...
      utils.send400(
        res,
        next,
        'Unable to parse multiple response scenario E (Two success responses with no model and one default response with no model) with return code "' +
          req.params.code +
          '" and type "' +
          req.params.type +
          '"',
  ...
  router.get("/payloads/default/A/response/:code/:type", function (req, res, next) {
    ...
    if (scenario !== null) {
      ...
      utils.send400(
        res,
        next,
        'Unable to parse multiple response scenario F (One default response with model) with return code "' +
          req.params.code +
          '" and type "' +
          req.params.type +
          '"',
  ...
  router.get("/payloads/default/none/response/:code/:type", function (req, res, next) {
    ...
    if (scenario !== null) {
      ...
      utils.send400(
        res,
        next,
        'Unable to parse multiple response scenario G (One default response with no model) with return code "' +
          req.params.code +
          '" and type "' +
          req.params.type +
          '"',
  ...
  router.get("/payloads/200/A/response/:code/:type", function (req, res, next) {
    ...
    if (scenario !== null) {
      ...
      utils.send400(
        res,
        next,
        'Unable to parse multiple response scenario H (One success response with model) with return code "' +
          req.params.code +
          '" and type "' +
          req.params.type +
          '"',
