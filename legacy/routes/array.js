...
var array = function (coverage) {
    ...
    if (req.params.type == "boolean") {
      ...
      if (req.params.scenario === "foo1.foo2.foo3") {
        ...
        res
          .status(400)
          .send(
            "Request scenario for string primitive type must contain foo1.foo2.foo3 or foo.null.foo2 or foo.123.foo2",
          );
      }
      ...
      if (req.params.scenario === "valid") {
        ...
        res
          ...
          .type("json")
          .end(
            '["6dcc7237-45fe-45c4-8a6b-3a8a3f625652", "d1399005-30f7-40d6-8da6-dd7c89ad34db", "f42f6aa1-a5bc-4ddf-907e-5f915de43205"]',
          );
      } else if (req.params.scenario === "invalidchars") {
      ...
      if (req.params.scenario === "valid") {
        ...
        res
          .status(200)
          .type("json")
          .end('["2000-12-01t00:00:01z", "1980-01-02T01:11:35+01:00", "1492-10-12T02:15:01-08:00"]');
      } else if (req.params.scenario === "invalidnull") {
      ...
      if (req.params.scenario === "valid") {
        ...
        res
          .status(200)
          .type("json")
          .end('["Fri, 01 Dec 2000 00:00:01 GMT", "Wed, 02 Jan 1980 00:11:35 GMT", "Wed, 12 Oct 1492 10:15:01 GMT"]');
      } else {
      ...
      if (req.params.scenario === "valid") {
        ...
        res
          .status(200)
          .type("json")
          .end('["' + bytesNull.toString("base64") + '", null]');
      } else {
      ...
      if (req.params.scenario === "valid") {
        ...
        res
          .status(200)
          .type("json")
          .end('["YSBzdHJpbmcgdGhhdCBnZXRzIGVuY29kZWQgd2l0aCBiYXNlNjR1cmw", "dGVzdCBzdHJpbmc", "TG9yZW0gaXBzdW0"]');
      } else {
  ...
  router.put("/prim/:type/:scenario", function (req, res, next) {
    if (req.params.type == "boolean") {
      ...
      if (req.params.scenario === "valid") {
        if (
          _.isEqual(utils.coerceDate(req.body), [
            ...
            "1980-01-02T00:11:35Z",
            "1492-10-12T10:15:01Z",
          ])
        ) {
      ...
      if (req.params.scenario === "valid") {
        if (
          _.isEqual(req.body, ["P123DT22H14M12.011S", "P5DT1H"]) ||
          _.isEqual(req.body, ["P123DT22H14M12.010999999998603S", "P5DT1H"])
        ) {
      ...
      if (req.params.scenario === "valid") {
        ...
        if (
          util.inspect(req.body) !==
          util.inspect([bytes1.toString("base64"), bytes2.toString("base64"), bytes3.toString("base64")])
        ) {
  ...
  router.get("/complex/:scenario", function (req, res, next) {
    if (req.params.scenario === "null") {
      ...
      res
        .status(200)
        .type("json")
        .end('[{"integer": 1, "string": "2"}, {"integer": 3, "string": "4"}, {"integer": 5, "string": "6"}]');
    } else {
      utils.send400(
        res,
        next,
        "Request path must contain null, empty, itemnull, itemempty, or valid for complex array get scenarios.",
      );
    }
  });
  ...
  router.get("/array/:scenario", function (req, res, next) {
    if (req.params.scenario === "null") {
      ...
      utils.send400(
        res,
        next,
        "Request path must contain null, empty, itemnull, itemempty, or valid for array of array get scenarios.",
      );
    }
  });
  ...
  router.get("/dictionary/:scenario", function (req, res, next) {
    if (req.params.scenario === "null") {
      ...
      res
        .status(200)
        .type("json")
        .end('[{"1": "one", "2": "two", "3": "three"}, null, {"7": "seven", "8": "eight", "9": "nine"}]');
    } else if (req.params.scenario === "itemempty") {
      coverage["getArrayDictionaryItemEmpty"]++;
      res
        .status(200)
        .type("json")
        .end('[{"1": "one", "2": "two", "3": "three"}, {}, {"7": "seven", "8": "eight", "9": "nine"}]');
    } else if (req.params.scenario === "valid") {
      ...
      utils.send400(
        res,
        next,
        "Request path must contain null, empty, itemnull, itemempty, or valid for dictionary array get scenarios.",
      );
    }
  });
