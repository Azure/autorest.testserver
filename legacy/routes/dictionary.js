...
var dictionary = function (coverage) {
    ...
    if (req.params.type == "boolean") {
      if (req.params.scenario === "tfft") {
        ...
        res
          .status(400)
          .send(
            "Request scenario for boolean primitive type must contain tfft or true.null.false or true.boolean.false",
          );
      }
      ...
      if (req.params.scenario === "1.-1.3.300") {
        ...
        res
          .status(400)
          .send("Request scenario for integer primitive type must contain 1.-1.3.300 or 1.null.zero or 1.boolean.0");
      }
      ...
      if (req.params.scenario === "1.-1.3.300") {
        ...
        res
          .status(400)
          .send("Request scenario for long primitive type must contain 1.-1.3.300 or 1.null.zero or 1.boolean.0");
      }
      ...
      if (req.params.scenario === "0--0.01-1.2e20") {
        ...
        res
          .status(400)
          .send(
            "Request scenario for float primitive type must contain 0--0.01-1.2e20 or 0.0-null-1.2e20 or 1.number.0",
          );
      }
      ...
      if (req.params.scenario === "0--0.01-1.2e20") {
        ...
        res
          .status(400)
          .send(
            "Request scenario for double primitive type must contain 0--0.01-1.2e20 or 0.0-null-1.2e20 or 1.number.0",
          );
      }
      ...
      if (req.params.scenario === "foo1.foo2.foo3") {
        ...
        res
          .status(400)
          .send(
            "Request scenario for float primitive type must contain foo1.foo2.foo3 or foo.null.foo2 or foo.123.foo2",
          );
      }
      ...
      if (req.params.scenario === "valid") {
        ...
        res
          .status(400)
          .send("Request scenario for date primitive type must contain valid or invalidnull or invalidchars");
      }
      ...
      if (req.params.scenario === "valid") {
        ...
        res
          .status(200)
          .type("json")
          .end('{"0": "2000-12-01t00:00:01z", "1": "1980-01-02T00:11:35+01:00", "2": "1492-10-12T10:15:01-08:00"}');
      } else if (req.params.scenario === "invalidnull") {
        ...
        res
          .status(400)
          .send("Request scenario for date-time primitive type must contain valid or invalidnull or invalidchars");
      }
      ...
      if (req.params.scenario === "valid") {
        ...
        res
          ...
          .type("json")
          .end(
            '{"0": "Fri, 01 Dec 2000 00:00:01 GMT", "1": "Wed, 02 Jan 1980 00:11:35 GMT", "2": "Wed, 12 Oct 1492 10:15:01 GMT"}',
          );
      } else {
      ...
      if (req.params.scenario === "valid") {
        ...
        res
          ...
          .end(
            '{"0": "' +
              bytes1.toString("base64") +
              '", "1": "' +
              bytes2.toString("base64") +
              '", "2": "' +
        ...
        res
          .status(200)
          .type("json")
          .end('{"0": "' + bytesNull.toString("base64") + '", "1": null}');
      } else {
      ...
      if (req.params.scenario === "valid") {
        ...
        res
          ...
          .type("json")
          .end(
            '{"0": "YSBzdHJpbmcgdGhhdCBnZXRzIGVuY29kZWQgd2l0aCBiYXNlNjR1cmw", "1": "dGVzdCBzdHJpbmc", "2": "TG9yZW0gaXBzdW0"}',
          );
      } else {
      ...
      res
        .status(400)
        .send(
          "Request path must contain boolean or integer or float or double or string or date or date-time or byte or base64url",
        );
    }
  });
  ...
  router.put("/prim/:type/:scenario", function (req, res, next) {
    if (req.params.type == "boolean") {
      ...
      if (req.params.scenario === "valid") {
        if (
          _.isEqual(utils.coerceDate(req.body), {
            0: "2000-12-01T00:00:01Z",
            1: "1980-01-01T23:11:35Z",
            2: "1492-10-12T18:15:01Z",
          })
        ) {
      ...
      if (req.params.scenario === "valid") {
        if (
          _.isEqual(req.body, {
            0: "Fri, 01 Dec 2000 00:00:01 GMT",
            1: "Wed, 02 Jan 1980 00:11:35 GMT",
      ...
      if (req.params.scenario === "valid") {
        if (
          _.isEqual(req.body, { 0: "P123DT22H14M12.011S", 1: "P5DT1H" }) ||
          _.isEqual(req.body, { 0: "P123DT22H14M12.010999999998603S", 1: "P5DT1H" })
        ) {
      ...
      if (req.params.scenario === "valid") {
        ...
        if (
          !_.isEqual(req.body, {
            0: bytes1.toString("base64"),
            1: bytes2.toString("base64"),
            2: bytes3.toString("base64"),
          })
        ) {
      ...
      res
        .status(400)
        .send("Request path must contain boolean or integer or float or double or string or date or date-time or byte");
    }
  });
  ...
  router.get("/complex/:scenario", function (req, res, next) {
    if (req.params.scenario === "null") {
      ...
      res
        .status(200)
        .type("json")
        .end('{"0": {"integer": 1, "string": "2"}, "1": null, "2": {"integer": 5, "string": "6"}}');
    } else if (req.params.scenario === "itemempty") {
      coverage["getDictionaryComplexItemEmpty"]++;
      res
        .status(200)
        .type("json")
        .end('{"0": {"integer": 1, "string": "2"}, "1": {}, "2": {"integer": 5, "string": "6"}}');
      ...
      res
        ...
        .type("json")
        .end(
          '{"0": {"integer": 1, "string": "2"}, "1": {"integer": 3, "string": "4"}, "2": {"integer": 5, "string": "6"}}',
        );
    } else {
      utils.send400(
        res,
        next,
        "Request path must contain null, empty, itemnull, itemempty, or valid for complex dictionary get scenarios.",
      );
    }
  });
  ...
  router.get("/array/:scenario", function (req, res, next) {
    if (req.params.scenario === "null") {
      ...
      utils.send400(
        res,
        next,
        "Request path must contain null, empty, itemnull, itemempty, or valid for dictionary of array get scenarios.",
      );
    }
  });
  ...
  router.get("/dictionary/:scenario", function (req, res, next) {
    if (req.params.scenario === "null") {
      ...
      res
        .status(200)
        .type("json")
        .end('{"0": {"1": "one", "2": "two", "3": "three"}, "1": {}, "2": {"7": "seven", "8": "eight", "9": "nine"}}');
    } else if (req.params.scenario === "valid") {
      ...
      utils.send400(
        res,
        next,
        "Request path must contain null, empty, itemnull, itemempty, or valid for dictionary dictionary get scenarios.",
      );
    }
  });
